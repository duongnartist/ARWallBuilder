...
class Beachball {
    ...
    class func node() -> SCNNode {
        ...
        body.collisionBitMask = CollisionTypes.solid.rawValue | CollisionTypes.wall.rawValue
        // CollisionTypes.solid.rawValue|CollisionTypes.wall.rawValue|CollisionTypes.beachball.rawValue
        body.contactTestBitMask = CollisionTypes.wall.rawValue
